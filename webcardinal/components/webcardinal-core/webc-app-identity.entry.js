...
const WebcAppIdentity = class {
  ...
  render() {
    ...
    return (h(Host, Object.assign({}, attributes), this.avatar ? h("img", { src: this.avatar, alt: this.name, part: "avatar" }) : null, h("a", { href: "/", class: "name", part: "name" }, this.name), h("a", { href: `mailto:${this.email}`, class: "email", part: "email" }, this.email)));
  }
};
