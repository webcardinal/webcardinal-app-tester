...
import { af as URLHelper, P as PAGES_PATH, H as HOOK_TYPE, a9 as promisifyEventEmit } from './index-8ae4b65b.js';
import { H as HostElement } from './index-b92a2e6e.js';
import { C as ComponentsListenerService } from './index-d3647f32.js';
import './index.esm.js';
import { p as proxifyModelProperty } from './Controller-4824fbca.js';
...
const WebcAppRouter = class {
  ...
  render() {
    return (h("stencil-router", { "data-root": this.basePath + '/', root: this.basePath + '/' }, h("stencil-route-switch", { scrollTopOffset: 0 }, this.content)));
  }
};
__decorate([
  HostElement()
