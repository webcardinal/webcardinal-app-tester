import { ao as getTranslationsFromState, ap as getSkinFromState, ar as getPathname, V as VIEW_MODEL_KEY, d as MODEL_CHAIN_PREFIX, i as TAG_ATTRIBUTE, j as TAG_MODEL_FUNCTION_PROPERTY, P as PAGES_PATH, ak as URLHelper } from './index-0e9697d2.js';
import './index.esm.js';
...
function translate(translationChain, translationModel) {
  if (!getTranslationsFromState()) {
    console.warn(
...
export { Controller as C, PskBindableModel as P, getTranslationModel as g, proxifyModelProperty as p, translate as t };
