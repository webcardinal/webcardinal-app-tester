const NAMESPACE = 'webcardinal';
const BUILD = /* webcardinal */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: true, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: true, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: true, disconnectedCallback: true, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propMutable: true, propNumber: false, propString: true, reflect: true, safari10: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: false, slot: true, slotChildNodesFix: false, slotRelocation: false, state: true, style: false, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: false, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: false, vdomXlink: false, watchCallback: true };
const Env = /* webcardinal */ {};
...
const GLOBALS$1 = window.cardinal.customTheme;
...
async function getTheme(host, asyncCallback) {
  host.dispatchEvent(new CustomEvent(GLOBALS$1.EVENTS.GET_THEME, {
...
async function injectTheme(host) {
  ...
  const path = `${basePath}/themes/${GLOBALS$1.THEME}/components/${componentName}/${file}`;
  if (!GLOBALS$1.IMPORTS[path]) {
    const [status, style] = await getDependency(path);
    if (status)
      GLOBALS$1.IMPORTS[path] = style;
    else
      return;
  }
  const styles = GLOBALS$1.IMPORTS[path];
  if (host.shadowRoot) {
    ...
    host.dispatchEvent(new CustomEvent(GLOBALS$1.EVENTS.ADD_STYLE, {
      bubbles: true, cancelable: true, composed: true,
      detail: {
        data: {
          tag: componentName,
...
function memorizeStyledElements(shadowRoot) {
  ...
  element.addEventListener(GLOBALS$1.EVENTS.ADD_STYLE, (event) => {
    event.preventDefault();
    event.stopImmediatePropagation();
  ...
  element.addEventListener(GLOBALS$1.EVENTS.REMOVE_STYLE, (event) => {
    event.preventDefault();
    event.stopImmediatePropagation();
...
function CustomTheme_v2() {
  return (proto) => {
    ...
    proto.disconnectedCallback = async function () {
      const host = getElement(this);
      host.dispatchEvent(new CustomEvent(GLOBALS$1.EVENTS.REMOVE_STYLE, {
        bubbles: true, cancelable: true, composed: true,
        detail: {
          data: {
...
const GLOBALS = {
  VERSIONS: [
    { ref: CustomTheme$1, version: 'v1.0' },
...
const EVENT_TYPE$1 = EVENTS_TYPES.PSK_BUTTON_EVT;
...
export { BUILD as B, CSS as C, H, NAMESPACE as N, TableOfContentProperty as T, promiseResolve as a, bootstrapLazy as b, consoleDevInfo as c, doc as d, cardinalInternalsGlobalScript as e, BindModel as f, getElement as g, h, CustomTheme as i, Build as j, plt as p, registerInstance as r, stringToBoolean as s, win as w };
